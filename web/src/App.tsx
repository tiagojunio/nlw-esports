            ...
            <form className="mt-8 flex flex-col gap-4">
              ...
              <div className='grid grid-cols-2 gap-6'>
                ...
                <div className='flex flex-col gap-2'>
                  ...
                  <Input id="discord" type="text" placeholder="Usuariodiscord#0000" />
                </div>
              </div>

              <div className='flex gap-6'>
                <div className='flex flex-col gap-2'>
                  <label htmlFor='weekDays'>Quando costumajogar?</label>
              ...
              <div className='gap-2 mt-2 flex text-sm'>
              ...
              <footer className='mt-4 flex justify-end gap-4'>
                <Dialog.Close
                  type="button"
                  className='bg-zinc-500 px-5 h-12 rounded font-semibold hover:bg-zinc-400'>
                  Cancelar
                </Dialog.Close>
